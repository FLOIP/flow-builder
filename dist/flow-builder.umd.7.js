...
var blockVuexNamespace = Object(lib["c" /* namespace */])("flow/".concat(MobilePrimitives_SelectManyResponseBlockStore["a" /* BLOCK_TYPE */]));
...
Object(tslib_es6["a" /* __decorate */])([blockVuexNamespace.Getter], MobilePrimitives_SelectManyResponseBlockvue_type_script_lang_ts_MobilePrimitives_SelectManyResponseBlock.prototype, "inflatedChoices", void 0);

Object(tslib_es6["a" /* __decorate */])([blockVuexNamespace.State], MobilePrimitives_SelectManyResponseBlockvue_type_script_lang_ts_MobilePrimitives_SelectManyResponseBlock.prototype, "inflatedEmptyChoice", void 0);

Object(tslib_es6["a" /* __decorate */])([blockVuexNamespace.Action], MobilePrimitives_SelectManyResponseBlockvue_type_script_lang_ts_MobilePrimitives_SelectManyResponseBlock.prototype, "editSelectOneResponseBlockChoice", void 0);

Object(tslib_es6["a" /* __decorate */])([blockVuexNamespace.Action], MobilePrimitives_SelectManyResponseBlockvue_type_script_lang_ts_MobilePrimitives_SelectManyResponseBlock.prototype, "editEmptyChoice", void 0);

Object(tslib_es6["a" /* __decorate */])([builderVuexNamespace.Getter], MobilePrimitives_SelectManyResponseBlockvue_type_script_lang_ts_MobilePrimitives_SelectManyResponseBlock.prototype, "isEditable", void 0);

MobilePrimitives_SelectManyResponseBlockvue_type_script_lang_ts_MobilePrimitives_SelectManyResponseBlock = Object(tslib_es6["a" /* __decorate */])([Object(vue_property_decorator["a" /* Component */])({
  components: {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"48ce26ce-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/interaction-designer/block-types/MobilePrimitives_SelectOneResponseBlock.vue?vue&type=template&id=794c0daf&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h3',{staticClass:"no-room-above"},[_vm._v(" "+_vm._s(_vm._f("trans")('flow-builder.edit-block-type',{block_type: _vm.trans(("flow-builder." + (_vm.block.type)))}))+" ")]),_c('fieldset',{attrs:{"disabled":!_vm.isEditable}},[_c('block-name-editor',{attrs:{"block":_vm.block}}),_c('block-label-editor',{attrs:{"block":_vm.block}}),_c('block-semantic-label-editor',{attrs:{"block":_vm.block}}),_c('div',{staticClass:"prompt-resource"},[(_vm.promptResource)?_c('resource-editor',{attrs:{"label":_vm._f("trans")('flow-builder.prompt'),"resource":_vm.promptResource,"block":_vm.block,"flow":_vm.flow}}):_vm._e()],1),_c('div',{staticClass:"question-prompt-resource"},[(_vm.questionPromptResource)?_c('resource-editor',{attrs:{"label":_vm._f("trans")('flow-builder.question-prompt'),"resource":_vm.questionPromptResource,"block":_vm.block,"flow":_vm.flow}}):_vm._e()],1),_c('div',{staticClass:"choices-prompt-resource"},[(_vm.choicesPromptResource)?_c('resource-editor',{attrs:{"label":_vm._f("trans")('flow-builder.choices-prompt'),"resource":_vm.choicesPromptResource,"block":_vm.block,"flow":_vm.flow}}):_vm._e()],1),_c('div',{staticClass:"form-group"},[_vm._l((Object.keys(_vm.inflatedChoices)),function(choiceKey){return [_c('hr'),_c('h4',[_vm._v(_vm._s(("Choice " + choiceKey)))]),(_vm.inflatedChoices[choiceKey].exit)?_c('block-exit-semantic-label-editor',{attrs:{"exit":_vm.inflatedChoices[choiceKey].exit,"block":_vm.block}}):_vm._e(),_c('resource-editor',{attrs:{"resource":_vm.inflatedChoices[choiceKey].resource,"block":_vm.block,"flow":_vm.flow}})]}),_c('hr'),_c('h4',[_vm._v(_vm._s(("Choice " + (Object.keys(_vm.inflatedChoices).length + 1))))]),_c('block-exit-semantic-label-editor',{attrs:{"exit":_vm.inflatedEmptyChoice.exit}}),_c('resource-editor',{attrs:{"resource":_vm.inflatedEmptyChoice.resource,"block":_vm.block,"flow":_vm.flow}})],2),_c('first-block-editor-button',{attrs:{"flow":_vm.flow,"block-id":_vm.block.uuid}})],1),_c('block-id',{attrs:{"block":_vm.block}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/interaction-designer/block-types/MobilePrimitives_SelectOneResponseBlock.vue?vue&type=template&id=794c0daf&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"48ce26ce-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/interaction-designer/block-editors/ExitSemanticLabelEditor.vue?vue&type=template&id=3cb1b748&
...
// CONCATENATED MODULE: ./src/components/interaction-designer/block-editors/ExitSemanticLabelEditor.vue?vue&type=template&id=3cb1b748&
...
//# sourceMappingURL=flow-builder.umd.7.js.map