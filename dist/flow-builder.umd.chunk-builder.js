...
// CONCATENATED MODULE: ./src/views/ImportFlow.vue?vue&type=template&id=1d5f4d77&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  ImportMatchervue_type_template_id_431c8a0c_render,
  ImportMatchervue_type_template_id_431c8a0c_staticRenderFns,
  false,
  null,
  null,
  null
...
var ErrorHandler_component = Object(componentNormalizer["a" /* default */])(
  ...
  ErrorHandlervue_type_template_id_ddfc5760_render,
  ErrorHandlervue_type_template_id_ddfc5760_staticRenderFns,
  false,
  null,
  null,
  null
...
var import_getters = {
  ...
  unsupportedBlockClasses: function unsupportedBlockClasses(state, getters, rootState, rootGetters) {
...
var actions = {
  setFlowJson: function setFlowJson(_ref, value) {
    return Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var commit, state, dispatch, flowContainer, oldFlowContainer, newFlowContainer, newPropertyBlocks, newGroupBlocks;
  ...
  validateLanguages: function validateLanguages(_ref2, flowContainer) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              state = _ref2.state, commit = _ref2.commit, rootGetters = _ref2.rootGetters;
  ...
  validateProperties: function validateProperties(_ref3, newPropertyBlocks) {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              rootGetters = _ref3.rootGetters, state = _ref3.state, commit = _ref3.commit;
              matchingProperties = [];
  ...
  validateGroups: function validateGroups(_ref4, newGroupBlocks) {
  ...
  matchLanguage: function matchLanguage(_ref5, _ref6) {
    var commit = _ref5.commit,
        state = _ref5.state,
        dispatch = _ref5.dispatch;
    var oldLanguage = _ref6.oldLanguage,
        matchingNewLanguage = _ref6.matchingNewLanguage;
  ...
  matchProperty: function matchProperty(_ref7, _ref8) {
    var commit = _ref7.commit,
        state = _ref7.state,
        dispatch = _ref7.dispatch;
    var oldProperty = _ref8.oldProperty,
        matchingNewProperty = _ref8.matchingNewProperty;
  ...
  matchGroup: function matchGroup(_ref9, _ref10) {
    var commit = _ref9.commit,
        state = _ref9.state,
        dispatch = _ref9.dispatch;
    var oldGroup = _ref10.oldGroup,
        matchingNewGroup = _ref10.matchingNewGroup;
    var blocks = Object(lodash["cloneDeep"])(Object(lodash["get"])(state.flowContainer, 'flows[0].blocks'));
    if (!blocks) return;
  ...
  Object(createClass["a" /* default */])(ImportFlow, [{
    ...
    value: function () {
      var _handleFileUpload = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
        ...
        var selectedFile, reader, contents;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                contents = reader.readAsText(selectedFile, 'UTF-8');
...
//# sourceMappingURL=flow-builder.umd.chunk-builder.js.map