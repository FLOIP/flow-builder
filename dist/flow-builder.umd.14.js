...
// CONCATENATED MODULE: ./src/components/interaction-designer/block-types/Core_LogBlock.vue?vue&type=template&id=8d269cc6&
...
var actions = {
  createWith: function createWith(_ref, _ref2) {
    return Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var rootGetters, commit, dispatch, props, contentTypeOverrides, blankLogResource, exits;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return dispatch('flow/flow_addBlankResourceForEnabledModesAndLangs', Object.values(dist["SupportedMode"]).reduce(function (memo, mode) {
                memo[mode] = dist["SupportedContentType"].TEXT;
                return memo;
              }, contentTypeOverrides), {
                root: true
              });
