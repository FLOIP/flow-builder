module.exports = {
  ...
  extends: ['plugin:vue/recommended', '@vue/airbnb', '@vue/typescript/recommended', 'plugin:jest/recommended', 'plugin:lodash/recommended', 'eslint:recommended', 'plugin:import/errors', 'plugin:import/warnings', 'plugin:import/typescript', 'plugin:@typescript-eslint/eslint-recommended', 'plugin:@typescript-eslint/recommended', 'plugin:@typescript-eslint/recommended-requiring-type-checking', 'plugin:@viamo/recommended', 'plugin:storybook/recommended'],
  plugins: ['jest', 'lodash', '@typescript-eslint'],
  overrides: [{
    files: ['*.js'],
    excludedFiles: '*.png',
    env: {
  ...
  rules: {
    ...
    '@viamo/vue-root-class-name': ['warn', ['validation-message']]
  }
};