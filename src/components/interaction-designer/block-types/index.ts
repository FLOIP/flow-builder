export {
  default as SmartDevices_PhotoResponseBlock,
  install as photoResponseBlockIntstaller,
} from './SmartDevices_PhotoResponseBlock.vue'
export {
  default as SmartDevices_LocationResponseBlock,
  install as locationResponseBlockInstaller,
} from './SmartDevices_LocationResponseBlock.vue'
export {
...
} from './MobilePrimitives_OpenResponseBlock.vue'
export {
  default as MobilePrimitives_NumericResponseBlock,
  install as numericResponseBlockInstaller,
} from './MobilePrimitives_NumericResponseBlock.vue'
export {
  default as MobilePrimitives_MessageBlock,
  install as messageBlockInstaller,
} from './MobilePrimitives_MessageBlock.vue'
export {
  default as Core_CaseBlock,
  install as caseBlockInstaller,
} from './Core_CaseBlock.vue'
export {
  default as Core_SetGroupMembershipBlock,
...
export {
  default as Core_LogBlock,
  install as logBlockInstaller,
} from './Core_LogBlock.vue'
export {
