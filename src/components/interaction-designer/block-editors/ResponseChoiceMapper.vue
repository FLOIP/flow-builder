...
import UploadMonitor from './UploadMonitor.vue'
...
export class ResponseChoiceMapper extends mixins(FlowUploader, Permissions, Routes, Lang) {
...
export default ResponseChoiceMapper
</script>
