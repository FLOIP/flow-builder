...
class ContactPropertySelector extends mixins(Lang) {
  ...
  get selectedProperty() {
    const {
      set_contact_property: {
        // @ts-ignore // TODO: weird issue, the prop exists but TS is still popping an error >
        // Property 'property_key' does not exist on type 'SetContactProperty | SetContactProperty[]'
  ...
  @flowVuexNamespace.Mutation block_updateConfigByPath!: ({blockId, path, value}:
