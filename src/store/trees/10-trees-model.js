...
(function () {
  ...
  app.Tree.prototype = {
    ...
    filterBlockConnectionsAboveMax(blockKey) {
      ...
      _.each(_.filter(connections, { startBlockKey: blockKey }), (e) => {
    ...
    removeConnection(startBlockKey, outputKey) {
      ...
      if (startBlockKey && typeof outputKey !== 'undefined') {
        ...
        connections = _.without(connections, _.find(connections, { startBlockKey, outputKey }))
      } else if (startBlockKey) {
        // Filter literally everything with that starting block key
        connections = _.difference(connections, _.filter(connections, { startBlockKey }))
      }
