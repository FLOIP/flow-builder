...
import { BLOCK_CLASS_CONFIG as SELECT_ONE_RESPONSE_BLOCK_CLASS_CONFIG } from '@/components/interaction-designer/block-types/MobilePrimitives_SelectOneResponseBlock.vue'
