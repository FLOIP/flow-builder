...
import OpenResponseBlock from '../block-types/OpenResponseBlock.vue'
...
import openResponseBlockStore, {BLOCK_TYPE} from '../../stores/flow/block-types/MobilePrimitives_OpenResponseBlockStore'
